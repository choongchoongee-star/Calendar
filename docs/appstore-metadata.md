...
### Support URL
https://choongchoongee-star.github.io/Calendar/support.html

### Privacy Policy URL
https://choongchoongee-star.github.io/Calendar/privacy.html

### Marketing URL (선택)
https://choongchoongee-star.github.io/Calendar/
...
위 URL은 `package.json` repository URL(`choongchoongee-star/Calendar`)을 기반으로
기본 GitHub Pages 경로(`choongchoongee-star.github.io/Calendar/`)로 설정돼 있습니다.
커스텀 도메인을 사용 중이거나 Pages 설정이 다르면 아래 경로만 교체해주세요:
